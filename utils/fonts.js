...
export const getFontSizeForHeading = (level) => {
  const fontSizeMap = {
    1: "text-4xl sm:text-4xl md:text-5xl lg:text-6xl",  // Modèle de la première ligne
    2: "text-3xl sm:text-3xl md:text-4xl lg:text-5xl",
    3: "text-2xl sm:text-2xl md:text-3xl lg:text-4xl",
